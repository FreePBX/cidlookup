...
<input type="hidden" id="itemid" name="itemid" value="<?php echo htmlspecialchars($itemid)?>">
...
<div class="element-container">
	...
	<div class="row">
		<div class="col-md-12">
			<span id="http_query-help" class="help-block fpbx-help-block"><?php echo _("Query string, special token '[NUMBER]' will be replaced with caller number<br/>e.g.: number=[NUMBER]&source=crm<br/>'[NAME]' will be replaced with existing caller id name<br/>'[LANGUAGE]' will be replaced with channel language<br/>'[UNIQUEID]' will be replaced with unique Asterisk callID")?></span>
		</div>
	</div>
</div>
<!--END Query-->
